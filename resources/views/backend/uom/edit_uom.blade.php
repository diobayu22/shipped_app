                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Uom</a></li>

                            </ol>
                        </div>
                        <h4 class="page-title">Edit Uom</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('update.uom') }}" enctype="multipart/form-data">
                                    @csrf
